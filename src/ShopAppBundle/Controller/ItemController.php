...
use ShopAppBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ShopAppBundle:Item')->findAll();
     ...
     * @Method("POST")
     * @Template("ShopAppBundle:Item:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ShopAppBundle:Item:edit.html.twig")
     */
